<script setup lang="ts">
  ...
  const schema = object({
    ...
    data3: string().required('Selecione pelo menos uma alternativa'),
    religionchoice: string().required('Selecione pelo menos uma alternativa'),
  })
  ...
  <UForm
   ...
   >
    ...
    <div class="flex flex-col gap-2 p-2 w-1/2 mx-auto mt-1">
      ...
      <div class="rounded">
        <USelectMenu v-model="selected" :options="method" placeholder="Selecione o método de pagamento desejado" name="pay" required/>
      </div>
    </div>
    ...
    <div class="flex flex-col gap-2 p-2 w-1/2 mx-auto mt-1">
      ...
      <div class="rounded">
        <URadioGroup :ui="{wrapper: 'mt-1'}" v-model="selected1" legend="Necessita de cuidados médicos?" :options="options1" name="data1" required/>
        <URadioGroup :ui="{wrapper: 'mt-4'}" v-model="selected2" legend="Necessita de medicamentos?" :options="options2" name="data2" required/>
        <URadioGroup :ui="{wrapper: 'mt-4'}" v-model="selected3" legend="É alergico?" :options="options3" name="data3" required/>
      </div>
    </div>
    ...
    <div class="flex flex-col gap-2 p-2 w-1/2 mx-auto mt-1">
      ...
      <div class="rounded">
        <USelectMenu v-model="selected_religion" :options="religion" placeholder="Selecione sua religião" name="religionchoice" required/>
      </div>
    </div>
